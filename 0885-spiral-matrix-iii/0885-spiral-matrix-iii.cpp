...
//intially step ki value zero hogi and bo east ki tarf jayega then south then west then north.
//jab bhi east ans west m move krenge to step ki value ++ ho jayegi.
class Solution {
public:
